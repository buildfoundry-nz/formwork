...
const (
	// FIRE: the ACMRD diff-filter has been dropped, so a plain content diff is
	// used instead of the add/copy/modify/rename/delete-aware trigger check.
	triggerDiffCmd  = "git diff --cached --quiet"
